---
title: "Behind Bars: Statistical Insights into the Wellbeing of U.S. Prisoners"
author:
  - Monica Sainani
  - Kaavya Kalani
  - Aamishi Avarsekar
...
#Figure 1 
compares shows the cause of death among prisoners due to diseases. In order to accurately investigate, we adjusted the number of deaths caused by a particular disease by the total number of prisoners recorded for that year. This accounts for the differences in the number of deaths recorded between each cause.
...
ggplot(ts_data, aes(x = date, y = new_cases_per_100k, color = group)) +
  ...
  labs(x = NULL, y = "New cases per 100,000", title = "Seven-Day Moving Average of New Daily COVID-19 Cases") +
  theme_minimal() +
