...
## Source
For this analysis we have used multiple datasets. This paper uses the datasets available in the replication package of the original paper. The author of the original paper has collated a large range of files from multiple sources and we will be using some of the datasets from this collation.
...
This dataset is a compilation of data collated by the original paper’s author from different sources:
- Sourcebook of Criminal Justice Statistics
- Bureau of Justice Statistics Report
- Jail Inmates in 2018
- U.S. Population FRED Data
- World Prison Population Data
- Western B. and Pettit B data

There are three sheets in this file, we will be using sheet 1 which contains time series data for incarceration from 1925-2019; each year is associated with the number of imprisoned individuals per 100k people, calculated from the total population and total number of inmates.
We will use this dataset to get the counts of prisons for different years. The Prison variable in the dataset is that variable.

### msfp0116stt02data.csv and msfp0116stt09data.csv
The original paper’s author got this data from
- the BJS publication by E. Ann Carson, Mary P. Cowhig (2020), Mortality in State And Federal Prisons
- 2001-2016 Statistical Tables (NCJ 251920)

msfp0116stt02data.csv contains counts for causes of deaths of the prisoners for the years 2001, 2006-2016. These causes include blah blah blah. For our analysis we will not be considering 2001 but only 2006 to 2016 for the trends as it gives us a continuous period to observe trends over

msfp0116stt09data.csv contains counts for the same conditions but segmented by demographic factors instead of time, such as gender, race, and age. For our analysis, we will be using the stats segmented by gender and race.

### covidts01.csv
The original paper’s author got this data from
- Covid Prison Project (https://covidprisonproject.com) by Lauren BrinkelyRubinstein (UNC Chapel Hill) and Kathryn Nowotny (University of Miami).

This dataset contains the collective number of new cases and case rates per 100,000 among the incarcerated, prison staff, and the general population. The numbers are recorded on a daily basis from April 22, 2020 to the end of August 2020.
